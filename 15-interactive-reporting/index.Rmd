...
.pull-right[
```{r echo = FALSE}
include_graphics(path = "images/shiny-basic.png")
```
]
...
.pull-right[
```{r echo = FALSE}
include_graphics(path = "images/shiny-add-h1.png")
```
]
...
.pull-right[
```{r echo = FALSE}
include_graphics(path = "images/shiny-tags.png")
```
]
...
.pull-right[
```{r echo = FALSE}
include_graphics(path = "images/shiny-input.png")
```
]
...
.pull-right[
```{r echo = FALSE}
include_graphics(path = "images/shiny-addplot-placeholder.png")
```
]
