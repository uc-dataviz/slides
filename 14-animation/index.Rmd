...
```{r freedom-race, cache = TRUE, echo = FALSE, message = FALSE, warning = FALSE, gganimate = list(nframes = 300, fps = 15, start_pause = 10, end_pause = 10), out.width = "80%", cache = TRUE}
