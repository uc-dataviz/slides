...
```{r crimes-agg-map-2, echo = FALSE, out.width = "95%", fig.width = 12}
library(patchwork)
{
  chi_json %>%
    st_join(y = crimes_homicide_sf) %>%
...
# install.packages("sf")
usethis::use_course("uc-dataviz/vector-maps")
```
...
include_graphics(path = "https://c.tenor.com/aa3KO3VP0dQAAAAC/cj-the-west-wing.gif")
```
